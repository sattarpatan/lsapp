<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['action' => 'PostsController@store', 'method' => 'POST', 'enctype'=>'multipart/form-data']); ?>
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::text('title', '', array_merge(['class' => 'form-control', 'placeholder'=>'Title']))); ?>
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::textarea('body', '', array_merge(['id'=>'article-ckeditor','class' => 'form-control', 'placeholder'=>'Body Text']))); ?>
